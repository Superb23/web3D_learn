...
import { mesh, mesh_1, mesh_2, mesh_3 } from "./model"
...
document.getElementById("demo_11")?.appendChild(renderer.domElement)

// 性能统计
const stats = Stats()
document.getElementById("demo_11")?.appendChild(stats.dom)
